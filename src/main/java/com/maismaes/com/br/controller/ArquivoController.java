...
public class ArquivoController {
  ...
  /**
   * Armazena um arquivo no MongoDB GridFS e retorna seu ID. O ID retornado deve ser enviado como
   * {@code fileId} na mensagem WebSocket.
   *
  ...
  public ResponseEntity<String> upload(@RequestParam("file") MultipartFile file)
      throws IOException {
    log.info(
        "[Arquivo] Upload iniciado | Nome: {} | Tipo: {} | Tamanho: {} bytes",
  ...
  /**
   * Serve o arquivo armazenado no GridFS pelo seu ID. O Content-Type original é preservado para que
   * o browser possa renderizá-lo inline (imagens, áudios, etc).
   *
   * <p>GET /arquivo/{id}
   */
  @GetMapping("/{id}")
  public ResponseEntity<Resource> download(@PathVariable String id) throws IOException {
    ...
    log.info(
        "[Arquivo] Servindo arquivo | ID: {} | Nome: {} | ContentType: {}",
        id,
