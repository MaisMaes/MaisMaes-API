...
public interface GrupoTematicoRepository
    extends JpaRepository<GrupoTematico, Long>, JpaSpecificationExecutor<GrupoTematico> {
  ...
  @Query(
      "SELECT DISTINCT g FROM GrupoTematico g JOIN g.bairros b WHERE LOWER(b.nome) LIKE LOWER(CONCAT('%', :nome, '%'))")
