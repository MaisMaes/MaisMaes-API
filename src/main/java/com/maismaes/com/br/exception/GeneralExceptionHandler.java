...
public class GeneralExceptionHandler {
  ...
  public ResponseEntity<HashMap<String, String>> handleConstraintDeclarationException(
  ...
  public ResponseEntity<HashMap<String, String>> handleAuthenticationException(
  ...
  private HashMap<String, String> montaMensagemErro(String mensagem) {
    ...
    response.put(
        "horario", LocalDateTime.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss")));
    return response;
  }
  ...
  public ResponseEntity<HashMap<String, String>> handleUsuarioNaoEncontradoException(
    ...
    return ResponseEntity.status(HttpStatus.NOT_FOUND).body(montaMensagemErro(e.getMessage()));
  }

  @ExceptionHandler(SenhaException.class)
  public ResponseEntity<HashMap<String, String>> handleSenhaIgualException(SenhaException e) {
    return ResponseEntity.status(HttpStatus.CONFLICT).body(montaMensagemErro(e.getMessage()));
  }
  ...
  public ResponseEntity<HashMap<String, String>> handleCodigoRecuperacaoInvalidoException(
    ...
    return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(montaMensagemErro(e.getMessage()));
  }

  @ExceptionHandler(VerificarUnicidadeException.class)
  public ResponseEntity<HashMap<String, String>> handleVerificarUnicidadeException(
      VerificarUnicidadeException e) {
    return ResponseEntity.status(HttpStatus.CONFLICT).body(montaMensagemErro(e.getMessage()));
  }
}
