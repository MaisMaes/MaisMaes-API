...
public record CadastroInfocardDto(
    @Schema(description = "Título do infocard", example = "Auxílio Jurídico Gratuito")
    ...
    @Schema(
        ...
        String imagem,
    @Schema(description = "Link externo para mais informações", example = "https://gov.br/auxilio")
        String link) {
